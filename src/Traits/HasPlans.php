...
namespace Abrahamf24\Plans\Traits;
...
trait HasPlans
{
    ...
    public function subscribeTo($plan, int $duration = 30, bool $isRecurring = true)
    {
        ...
        if ($this->subscriptionPaymentMethod == 'stripe') {
            try {
                ...
                event(new \Abrahamf24\Plans\Events\Stripe\ChargeSuccessful($this, $subscription, $stripeCharge));
            } catch (\Exception $exception) {
                event(new \Abrahamf24\Plans\Events\Stripe\ChargeFailed($this, $subscription, $exception));
            }
        }

        event(new \Abrahamf24\Plans\Events\NewSubscription($this, $subscription));
    ...
    public function subscribeToUntil($plan, $date, bool $isRecurring = true)
    {
        ...
        event(new \Abrahamf24\Plans\Events\NewSubscriptionUntil($this, $subscription, $date));
    ...
    public function upgradeCurrentPlanTo($newPlan, int $duration = 30, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        event(new \Abrahamf24\Plans\Events\UpgradeSubscription($this, $subscription, $startFromNow, $oldPlan, $newPlan));
    ...
    public function upgradeCurrentPlanToUntil($newPlan, $date, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        event(new \Abrahamf24\Plans\Events\UpgradeSubscriptionUntil($this, $subscription, $date, $startFromNow, $oldPlan, $newPlan));
    ...
    public function extendCurrentSubscriptionWith(int $duration = 30, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        if ($startFromNow) {
            ...
            event(new \Abrahamf24\Plans\Events\ExtendSubscription($this, $activeSubscription, $startFromNow, null));
        ...
        event(new \Abrahamf24\Plans\Events\ExtendSubscription($this, $activeSubscription, $startFromNow, $subscription));
    ...
    public function extendCurrentSubscriptionUntil($date, bool $startFromNow = true, bool $isRecurring = true)
    {
        ...
        if ($startFromNow) {
            ...
            event(new \Abrahamf24\Plans\Events\ExtendSubscriptionUntil($this, $activeSubscription, $date, $startFromNow, null));
        ...
        event(new \Abrahamf24\Plans\Events\ExtendSubscriptionUntil($this, $activeSubscription, $date, $startFromNow, $subscription));
    ...
    public function cancelCurrentSubscription()
    {
        ...
        event(new \Abrahamf24\Plans\Events\CancelSubscription($this, $activeSubscription));
