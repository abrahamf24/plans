...
namespace Abrahamf24\Plans\Models;
...
class PlanSubscriptionModel extends Model
{
    ...
    public function consumeFeature(string $featureCode, float $amount)
    {
        ...
        event(new \Abrahamf24\Plans\Events\FeatureConsumed($this, $feature, $amount, $remaining));
    ...
    public function unconsumeFeature(string $featureCode, float $amount)
    {
        ...
        event(new \Abrahamf24\Plans\Events\FeatureUnconsumed($this, $feature, $amount, $remaining));
